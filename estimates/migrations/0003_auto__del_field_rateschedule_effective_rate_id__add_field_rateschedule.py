...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RateSchedule.effective_rate_id'
        db.delete_column(u'estimates_rateschedule', 'effective_rate_id_id')

        # Adding field 'RateSchedule.effective_rate'
        db.add_column(u'estimates_rateschedule', 'effective_rate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='rate_schedules', null=True, blank=True, to=orm['estimates.EffectiveRate']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RateSchedule.effective_rate_id'
        db.add_column(u'estimates_rateschedule', 'effective_rate_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='rate_schedules', to=orm['estimates.EffectiveRate']),
                      keep_default=False)

        # Deleting field 'RateSchedule.effective_rate'
        db.delete_column(u'estimates_rateschedule', 'effective_rate_id')
